...
namespace CTRPluginFramework
{
    ...
    struct Mannequin
    {
        u16 Hat; //Item ID < 0xXXXX
        u16 Accessory; //Item ID < 0xXXXX
        u16 TopWear; //Item ID < 0xXXXX
        u16 BottomWear; //Item ID < 0xXXXX
        u16 Socks; //Item ID < 0xXXXX
        u16 Shoes; //Item ID < 0xXXXX
    };
  ...
  /*73*/u8 PermitFinished : 1;
   ...
   struct UnknownStruct2
   {
    ...
    {
        u32 UnkItem1; //Some Item; Set to 0x00007ffe in player ctor
    ...
    struct VillagerFutureHome
    {
        ...
        u32 UnkItem1; //Group 1; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem2; //Group 1; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem3; //Group 1; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem4; //Group 1; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem5; //Group 1; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem6; //Group 1; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem7; //Group 1; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem8; //Group 1; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem9; //Group 2; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem10; //Group 2; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem11; //Group 2; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem12; //Group 2; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem13; //Group 2; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem14; //Group 2; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem15; //Group 2; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem16; //Group 2; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem17; //Group 3; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem18; //Group 4; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem19; //Group 5; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem20; //Group 6; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem21; //Group 7; Some Item; Set to 0x00007ffe in player ctor
        u8 UnkBitfield[8];
        u16 unk;
        TownID UnkTownID;
    ...
    { 
        ...
        u32 UnkItem3; //Group 1; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem4; //Group 1; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem5; //Group 2; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem6; //Group 2; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem7; //Group 2; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem8; //Group 2; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem9; //Group 3; Some Item; Set to 0x00007ffe in player ctor
        u32 UnkItem10; //Group 4; Some Item; Set to 0x00007ffe in player ctor
        ...
        u16 Shirt; //246E - 2471
        u16 Song; //2472 - 2475
        u16 Wallpaper; //2476 - 2479
        u16 Carpet; //247A - 247D
        u16 Umbrella; //247E - 2481
        u16 Furniture[16]; //2482 - 24C1
    ...
    struct TownSaveData
    {
        ...
        u32 TownItems[(16*16)*(5*4)]; //16*16 items per acre; Items only cover map acres (5*4); 0x1400 of items
        ...
        u32 LostAndFoundItems[16]; //0x621E2
        u8 Unknown5[16]; //0x62222; likely padding
        u64 Unknown6; //ctor sets 0x7FFFFFFFFFFFFFFF (max positive U64)
        u32 TownFruit; //Yes, the game uses an item id to represent the town fruit lol
        ...
        u32 KicksItems[6];
        u8 Unknown31[6];
        u32 UnkItems1[4]; //ctor does this and below seperately, 4 at a time
        u32 UnkItems2[4];
        u32 Padding5;
        ...
        u8 Unknown60[8]; 
        u32 UnkItem6;
        u32 UnkItems7[2]; //new year hats?
        u32 CampgroundShopItems[2];
        u8 Unknown61[4];
        ...
        ACNL_Date Unknown64; 
        u8 Unknown65[0x44];
        ACNL_Date FossilDonationDate[0x43]; //0x6AEB8 f
        ACNL_Date FishDonationDate[0x48]; //0x6AFC4 f
        ACNL_Date SeaCreatureDonationDate[0x1E]; //0x6B0E4 f
        ACNL_Date InsectDonationDate[0x48]; //0x6B15C f 
        ACNL_Date PaintingDonationDate[0x19]; //0x6B27C f
        ACNL_Date StatueDonationDate[0x08]; //0x6B2E0 f
        ...
        u32 IslandItems[(16*16)*(2*2)]; //0x6FED8; 16*16 items per acre; Items only cover map acres (2*2); 0x400 of items
