...
#define TAG_VERSION CTRPF_VERSION_MAJOR "." CTRPF_VERSION_MINOR "." CTRPF_VERSION_BUILD "_Custom"
...
namespace CTRPluginFramework
{
    ...
    static u32      FsTryOpenFileCallback(u32 a1, char16_t *fileName, u32 mode);
