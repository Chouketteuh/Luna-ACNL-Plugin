...
namespace CTRPluginFramework
{
    ...
    PluginMenuHome::PluginMenuHome(std::string &name, bool showNoteBottom, std::string &about) :

        _noteTB("", "", showNoteBottom ? IntRect(20, 46, 280, 124) : IntRect(40, 30, 320, 180)),
        _about(about),
        _abouttb("", _about, IntRect(40, 30, 320, 180)),

        _showStarredBtn(Button::Toggle | Button::Sysfont | Button::Rounded, "Favorite", IntRect(31, 70, 120, 30), Icon::DrawFavorite), //IntRect(30, 70, 120, 30)
        _hidMapperBtn(Button::Sysfont | Button::Rounded, "Mapper", showNoteBottom ? IntRect(320, 240, 0, 0) : IntRect(165, 140, 120, 30), Icon::DrawController), //IntRect(165, 70, 120, 30)
        _gameGuideBtn(Button::Sysfont | Button::Rounded, "Game Guide", IntRect(320, 240, 0, 0), Icon::DrawGuide), //IntRect(30, 105, 120, 30)
        _searchBtn(Button::Sysfont | Button::Rounded, "Search", IntRect(166, 70, 120, 30), Icon::DrawSearch), //IntRect(165, 105, 120, 30)
        _arBtn(Button::Sysfont | Button::Rounded, "Action Replay", IntRect(31, 105, 120, 30)), //IntRect(30, 140, 120, 30)
        _toolsBtn(Button::Sysfont | Button::Rounded, "Tools", IntRect(166, 105, 120, 30), Icon::DrawTools), //showNoteBottom ? IntRect(99, 172, 120, 30) : IntRect(165, 140, 120, 30)
        _creditsBtn(Button::Sysfont | Button::Rounded, "Credits", IntRect(99, 140, 120, 30), Icon::DrawGuide),
    ...
    bool PluginMenuHome::operator()(EventList& eventList, int& mode, Time& delta)
    {
        ...
        else if (_abouttb.IsOpen() && !ShowNoteBottom)
        {
            for (size_t i = 0; i < eventList.size(); i++)
                if (_abouttb.ProcessEvent(eventList[i]) == false)
                {
                    _creditsBtn.SetState(false);
                    break;
                }
        }
        else
        ...
        if (!ShowNoteBottom) {
            ...
            if (_creditsBtn()) _creditsBtn_OnClick();
...
#define IsUnselectableEntry(item) (item->IsEntry() && item->AsMenuEntryImpl()._flags.isUnselectable)
    ...
    void PluginMenuHome::_Update(Time delta)
    {
        ...
        *************/
        ...
        if (!ShowNoteBottom)
        {
            ...
            _creditsBtn.Update(isTouched, touchPos);
    ...
    void    PluginMenuHome::_creditsBtn_OnClick(void)
    {
        if (_abouttb.IsOpen())
            _abouttb.Close();
        else
