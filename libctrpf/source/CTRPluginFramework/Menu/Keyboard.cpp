...
namespace CTRPluginFramework
{
    ...
    ******/
    ...
    int Keyboard::Open(u8 &output) const
    {
        ...
        _keyboard->SetLayout(_hexadecimal ? Layout::HEXADECIMAL : Layout::DECIMAL, false);
        if (_hexadecimal)
        {
    ...
    ******/
    ...
    int Keyboard::Open(float &output) const
    {
        ...
        _keyboard->SetLayout(DECIMAL, true);
    ...
    **********/
    ...
    void    Keyboard::SetStartingPage(QwertyKeyboardPage page)
    {
        _keyboard->SetStartingPage(page);
    }

    void    Keyboard::SetBlockedKeys(const std::vector<int>& blockedKeys)
    {
        _keyboard->SetBlockedKeys(blockedKeys);
    }

    void    Keyboard::SetAllowedKeys(const std::vector<int>& allowedKeys)
    {
        _keyboard->SetAllowedKeys(allowedKeys);
    }
